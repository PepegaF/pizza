      ...
      <div className={`${'container'} ${'containerCart'}`}>
         ...
         <div className={s.cart}>
            <div className={s.cartTop}>
               <h2 className={s.contentTitle}><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div className={s.cartClear}>
                  ...
                  <span onClick={() => { dispatch(removeAllPizzaFromCart()) }}>Очистить корзину</span>
               </div>
            </div>
            ...
            <div className={s.cartBottom}>
               ...
               <div className={s.cartBottomButtons}>
                  <NavLink to={'../home'}>
                     <div className={`${s.button} ${s.buttonOutline} ${s.buttonAdd} ${s.goBackBtn}`}>
                  ...
                  <div className={`${s.button} ${s.payBtn}`}>
